  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-gray-100 dark:bg-gray-900">
      ...
      <Card className="w-full max-w-md p-6 bg-white dark:bg-gray-800 shadow-lg rounded-lg">
        ...
        <CardHeader>
          <CardTitle className="text-3xl font-bold text-amber-950 text-center">
            Simple Calculator
          </CardTitle>
        </CardHeader>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="grid grid-cols-4 gap-2">
            <Button
              variant="outline"
              className="text-2xl font-bold  bg-red-700"
              onClick={add}
            >
              +
            </Button>
          ...
          <Button variant="outline" className="w-full bg-red-700" onClick={clear}>
            Clear
          </Button>
        </CardContent>
      </Card>
